...
export default function Home() {
  return (
    <Container>
      <div className='inset-0 max-w-2xl mx-auto mt-48 flex flex-col gap-8'>
        ...
        <p className='text-lg bg-gradient-to-b lg:bg-gradient-to-r from-yellow-100/80 to-yellow-300/30 dark:from-gray-500/30 dark:to-gray-500/30 bg-clip-text text-transparent'>
        ...
        <p className='text-lg bg-gradient-to-b lg:bg-gradient-to-r from-yellow-100/60 to-yellow-300/20 dark:from-gray-500/30 dark:to-gray-500/30 bg-clip-text text-transparent'>
        ...
        <p className='text-lg bg-gradient-to-b lg:bg-gradient-to-r from-yellow-100/50 to-yellow-300/10 dark:from-gray-500/30 dark:to-gray-500/30 bg-clip-text text-transparent'>
